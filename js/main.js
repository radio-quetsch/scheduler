    ...
    Object.keys(myJson).forEach(function(item) {
        ...
        if (item != "AIRTIME_API_VERSION") {
            ...
            if (now.getMonth() == dayDate.getMonth() && now.getDate() == dayDate.getDate()) {
                ...
                weeklySchedulerTabContent += '<div class="tab-pane fade show active" id="'+ item +'" role="tabpanel" aria-labelledby="' + item + '-tab"><table class="table table-dark table-striped"><thead><th>horraire</th><th>Programme</th></thead><tbody>';
